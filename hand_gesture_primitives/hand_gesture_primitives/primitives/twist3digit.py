...
# O20 semantic 20-DOF: 拇食中三指捏取预备姿态
PINCH_ANGLES_READY = [
    0.0,         # [0]  thumb_base: 伸出准备捏
    77.0,        # [1]  index_base: 半弯准备捏
    77.0,        # [2]  middle_base: 半弯准备捏
...
PINCH_ANGLES_END = [
    ...
    0.0, 0.0, 0.0, 0.0,  # [11-14] reserved
    128.0,       # [15] thumb_tip
    133.0,       # [16] index_tip: 更弯
    158.0,       # [17] middle_tip: 更弯
    255.0,       # [18] ring_tip: 握拳
    255.0,       # [19] pinky_tip: 握拳
]
...
class Twist3Digit(HandGesturePrimitive):
    ...
    def compute(
        ...
        if t < self.PINCH_DURATION:
            ...
            delta[5] *= 1 - 0.3#self.CHECK_TOUCH
            delta[6] *= 1 - 0.3#self.CHECK_TOUCH
            delta[7] *= 1 - 0.3#self.CHECK_TOUCH
