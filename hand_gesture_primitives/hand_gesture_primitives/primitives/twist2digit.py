...
TWIST_DELTA_ANGLE = [
    ...
    0.0,         # [3]  ring_base
    0.0,         # [4]  pinky_base
    -200.0,        # [5]  thumb_abd: 拇指侧摆
    -300.0,      # [6]  index_abd: 食指侧摆
    0.0,         # [7]  middle_abd
    0.0,         # [8]  ring_abd
    0.0,         # [9]  pinky_abd
    0.0,         # [10] thumb_rot
...
class Twist2Digit(HandGesturePrimitive):
    ...
    def compute(
        ...
        if t < self.PINCH_DURATION:
            ...
            delta[5] *= 1 - 0.5#self.CHECK_TOUCH
            delta[6] *= 1 - 0.5#self.CHECK_TOUCH
