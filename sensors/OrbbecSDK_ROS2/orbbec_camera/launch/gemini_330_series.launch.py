...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('depth_precision', default_value='0.1mm'),
        ...
        DeclareLaunchArgument('exposure_range_mode', default_value='ultimate'),#default, ultimate or regular
        ...
        DeclareLaunchArgument('ldp_power_level', default_value='50'),
        ...
        DeclareLaunchArgument('depth_precision', default_value='high'),
